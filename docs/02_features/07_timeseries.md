...
| ClickHouse 접속 불가 | **채번 보류** — 조회 표면의 응답 상태 미정 | 11_glossary/02 채번 보류 · 결정 자리 [../03_requirements/08_timeseries.md](../03_requirements/08_timeseries.md) | TSQ-01 · 09 |
...
|------|------|------|------|
| ClickHouse 불가 시 조회 응답 | ClickHouse 중단 시 적재가 XACK를 보류한다는 것뿐이다 | 채번 보류(W1 등재) | [../03_requirements/08_timeseries.md](../03_requirements/08_timeseries.md) |
