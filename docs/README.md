...
| 호스트 포트 | 전부 **127.0.0.1 바인드** — 웹 3001 · api 3000 · postgres 5432 · clickhouse 8123 · 9000 · 9363 · redis 6379 · (프로파일) prometheus 9090 · grafana 3002. PlcSim 5020~5119는 컨테이너 내부 루프백 전용이라 publish하지 않는다. **웹 3001은 Compose 밖이다** — 바인드는 개발 서버 기동 인자로 강제한다(정본 [12_security/05_local_exposure.md](./12_security/05_local_exposure.md)) |
