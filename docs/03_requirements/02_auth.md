...
| WebSocket 인증 실패 · Origin 불일치 종료 코드 | 닫힘 — Origin 불일치 · 역할 0 사용자 4403 · 인증 실패 4401(종료 코드 8종) — [../07_api/11_websocket.md](../07_api/11_websocket.md) | [../07_api/11_websocket.md](../07_api/11_websocket.md)(W5) |
