...
| 항목 | 기준 |
|------|------|
| 요구사항 ID | REQ-{도메인}-NN · 횡단 접두 GLB(전역) · NFR(비기능) · TEC(기술운영). 총수 **228** — GLB 23 · AUT 17 · MST 15 · COL 16 · SIM 12 · GEN 15 · ING 18 · TSQ 17 · RLT 18 · ALM 20 · WRK 12 · OBS 12 · NFR 18 · TEC 15. 세는 자리는 각 파일의 요구사항 표 |
