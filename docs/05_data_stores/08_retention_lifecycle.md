...
| 항목 | 상태 | 확정 자리 |
|------|------|------|
| TTL 머지 주기 · 파티션 삭제 지연 | 서버 기본값 — 실측 전 미확인 | [../09_tech_stack/03_data_infra.md](../09_tech_stack/03_data_infra.md)(W6) |
...
| 분리된 alarm_event 파티션의 아카이브 위치 · 형식 | "덤프 파일"만 있다 | [../09_tech_stack/04_local_environment.md](../09_tech_stack/04_local_environment.md)(W6) |
