...
| 환경변수 | **25**(스위치 11 + 스위치 밖 14) — 정본 [04_local_environment.md](./04_local_environment.md) §환경변수 |
| 버전 고정표 | **35행**(재확인 대기 24 · 미고정 10 · 해당 없음 1) — 착수 시점 공식 릴리스 노트 재확인 전까지 확정 태그가 아니다 · 정본 [03_data_infra.md](./03_data_infra.md) |
