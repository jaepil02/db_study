...
| 환경변수 | **34**(스위치 11 + 스위치 밖 23 — 비밀 9 포함) — 정본 [04_local_environment.md](./04_local_environment.md) §환경변수 |
| 버전 고정표 | **36행**(태그 고정 3 · 버전 고정 1 · 재확인 대기 21 · 미고정 10 · 해당 없음 1) — 착수 시점 공식 릴리스 노트 재확인 전까지 확정 태그가 아니다 · 정본 [03_data_infra.md](./03_data_infra.md) |
