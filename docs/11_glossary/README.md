...
| [04_id_conventions.md](./04_id_conventions.md) | **ID 규약 정본** — 채번 규칙 · 말미 채번 · 결번 보존 · 예약 대역 · 원본 흐름 표기 F1 → F-01 대응 · Redis 키 · 메트릭 · 측정 기록 파일명 | 루트 README ID 규약 · data_flow §1 | W1 |
...
| 에러 코드 | {domain}.{snake_case} + HTTP 상태. 종수와 네임스페이스 수는 W1 채번 후 이 표와 루트 README에 올린다 |
